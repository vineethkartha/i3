# This script is based on the original work in the link below
...
parser.add_argument(
    '--command',
    type=str,
    metavar='The command to play or pause the track',
...
try:
    ...
    spotify_control = dbus.Interface(spotify_bus, 'org.mpris.MediaPlayer2.Player')
    metadata = spotify_properties.Get('org.mpris.MediaPlayer2.Player', 'Metadata')
    status = spotify_properties.Get('org.mpris.MediaPlayer2.Player', 'PlaybackStatus')

    if control_command == 'toggle':
        spotify_control.PlayPause();
    elif control_command == 'next':
        spotify_control.Next()
    elif control_command == 'prev':
